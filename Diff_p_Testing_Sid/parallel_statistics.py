...
"""simulation parameters for 8 segments"""
...
output_dir = os.path.join(os.path.dirname(__file__), "Data_400k_32b_8seg_a22_test_contrast_memory_dist")
...
configurations = [
    {
        ...
        "file_name": "compare_fixed_length_32-8_a22_131_10_40_04_400km.csv",
    },
    {
        "memory_numbers_list": [3, 3, 3, 3, 1, 1, 1, 1, 1, 1, 1, 1, 3, 3, 3, 3],
        "segment_lengths": [s2, s2, s1, s1, s1, s1, s2, s2],
        "file_name": "compare_fixed_length_32-8_a22_313_10_40_04_400km.csv",
    },
    {
        "memory_numbers_list": [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
        "segment_lengths": [s2, s2, s1, s1, s1, s1, s2, s2],
        "file_name": "compare_fixed_length_32-8_a22_2222_10_40_04_400km.csv",
    },
    # {
...
# # Define the new directory for storing CSV files
# output_dir = os.path.join(os.path.dirname(__file__), "Data_test_dl")
# os.makedirs(output_dir, exist_ok=True)  # Create the directory if it doesn't exist
...
#     {
#         "memory_numbers_list": [2, 2, 2, 2, 2, 2, 2, 2],
#         "segment_lengths": [s5, s5, 100, s5],
#         "file_name": "compare_fixed_length_32-4_a22_25_25_44_200km.csv",
#     },
#     {
#         "memory_numbers_list": [2, 2, 2, 2, 2, 2, 2, 2],
#         "segment_lengths": [s5, s5, s5, s5],
#         "file_name": "compare_fixed_length_16-4_a22_25_25_44_100km.csv",
#     },
# ]
...
dataa = np.linspace(0.4, 1.0, 6)  # Swapping probability range
