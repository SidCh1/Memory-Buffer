...
def plot_csv_data(file_list):
    ...
    for file in file_list:
        ...
        # Add a legend entry
        plt.scatter([], [], color=color, marker=marker, 
...
if __name__ == "__main__":
    ...
    csv_files = [
        ...
        'compare_fixed_length_16-4_a11_20_40.csv',
        'compare_fixed_length_32-4_a11_20_40_37.csv'
        # 'compare_fixed_length_32-4_15_55.csv',
        # 'compare_fixed_length_32-4_25_25.csv',
    ]
