...
#print("working? ", elemlink._is_working, ", multiplicity: ", elemlink._multiplicity, elemlink._multiplicity_vec)
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space)
#elemlink.check_buffer_space()
#print("ready for generation? ", elemlink._ready_for_generation)
#elemlink.generation_attempt()
#print("generation successful? ", elemlink._is_working, ", _multiplicity: ", elemlink._multiplicity, elemlink._multiplicity_vec)
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space)
#elemlink.check_buffer_space()
#print("ready for generation? ", elemlink._ready_for_generation)
#print("turn off")
...
#print("ready for generation? ", elemlink._ready_for_generation)
#elemlink.generation_attempt()
#print("generation successful? ", elemlink._is_working, ", _multiplicity: ", elemlink._multiplicity, elemlink._multiplicity_vec, "working? ", elemlink._is_working)
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space)
#elemlink.check_buffer_space()
#print("ready for generation? ", elemlink._ready_for_generation)
#elemlink.generation_attempt()
#print("generation attempt, link working? ", elemlink._is_working, ", _multiplicity: ", elemlink._multiplicity, elemlink._multiplicity_vec, "working? ", elemlink._is_working)
#print("turn off")
#elemlink.turn_off()
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space, ", _multiplicity: ", elemlink._multiplicity, elemlink._multiplicity_vec, "working? ", elemlink._is_working)
#print("turn off")
#elemlink.turn_off()
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space, ", _multiplicity: ", elemlink._multiplicity, elemlink._multiplicity_vec, "working? ", elemlink._is_working)
#elemlink.next_timestep()
#print("apply next timestep. working in next timestep? ", elemlink._is_working)
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space, ", _multiplicity: ", elemlink._multiplicity, elemlink._multiplicity_vec, "working? ", elemlink._is_working)
#elemlink.next_timestep()
#print("apply next timestep. working in next timestep? ", elemlink._is_working)
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space, ", _multiplicity: ", elemlink._multiplicity, elemlink._multiplicity_vec, "working? ", elemlink._is_working)
...
print("\n \n \n Test of Elementary Link, coherence time")
elemlink = memb.Elementary_Link(generation_probability=1,coherence_time = 3, memoryL = memb.Memory(buffer_space=3),memoryR = memb.Memory(buffer_space=3))
print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space, ", _multiplicity: ", elemlink._multiplicity_vec, "working? ", elemlink._is_working)
elemlink.next_timestep()
