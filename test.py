...
#print("\n \n \n Test of Elementary Link, coherence time")
#elemlink = memb.Elementary_Link(generation_probability=0.8,coherence_time = 3, memoryL = memb.Memory(buffer_space=3),memoryR = memb.Memory(buffer_space=3))
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space, ", _multiplicity: ", elemlink._multiplicity_vec, "survivaltime_max: ", elemlink.survivaltime_max,  "working? ", elemlink._is_working)
...
#print("reduce coherence time, generation attempt")
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space, ", _multiplicity: ",  elemlink._multiplicity_vec, "survivaltime_max: ", elemlink.survivaltime_max,  "working? ", elemlink._is_working)
#elemlink.turn_off(elemlink.survivaltime_max)
#print("turn_off(survivaltime_max)")
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL._occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR._occupied_buffer_space, ", _multiplicity: ",  elemlink._multiplicity_vec, "survivaltime_max: ", elemlink.survivaltime_max,  "working? ", elemlink._is_working)
...
print("Test of Long Link - coherence time")
...
llink = memb.Long_Link(link1=link1,link2=link2,swapping_probability=1)
print("free memory space, L: ", llink.memoryL.buffer_space - llink.memoryL._occupied_buffer_space, "R: ", llink.memoryR.buffer_space - llink.memoryR._occupied_buffer_space, ", multiplicity: ", llink._multiplicity_vec)
link1.next_timestep()
link1.next_timestep()
link2.next_timestep()
link2.next_timestep()
