...
#print("ready for generation? ", elemlink.ready_for_generation)
#elemlink.generation_attempt()
#print("generation successful? ", elemlink.is_working, ", multiplicity: ", elemlink.multiplicity, "working? ", elemlink.is_working)
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL.occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR.occupied_buffer_space)
#elemlink.check_buffer_space()
#print("ready for generation? ", elemlink.ready_for_generation)
#elemlink.generation_attempt()
#print("generation attempt, working? ", elemlink.is_working, ", multiplicity: ", elemlink.multiplicity, "working? ", elemlink.is_working)
#print("turn off")
#elemlink.turn_off()
#rint("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL.occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR.occupied_buffer_space, ", multiplicity: ", elemlink.multiplicity, "working? ", elemlink.is_working)
#print("turn off")
#elemlink.turn_off()
#print("free memory space, L: ", elemlink.memoryL.buffer_space - elemlink.memoryL.occupied_buffer_space, "R: ", elemlink.memoryR.buffer_space - elemlink.memoryR.occupied_buffer_space, ", multiplicity: ", elemlink.multiplicity, "working? ", elemlink.is_working)
...
print("free memory space, L: ", llink.memoryL.buffer_space - llink.memoryL.occupied_buffer_space, "R: ", llink.memoryR.buffer_space - llink.memoryR.occupied_buffer_space, ", multiplicity: ", llink.multiplicity)
