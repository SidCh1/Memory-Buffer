...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 11 10:02:54 2023
...
datamean_list = []
datastdev_list = []
dataa = np.linspace(0.1,1.0,10) # Gen probability range
...
plt.title('swapping probability=%.2f, number_of_repetitions=%i' %(swapping_probability,number_of_repetitions))
# plt.yscale('log')


#constant_value = (9/4)*(1/swapping_probability**3)
#plt.axhline(y=constant_value, color='r', linestyle='--', label='lower bound')
